      ...
      <nav>
        ...
        <ul className={menuOpen ? 'open' : ''}>
          ...
          <li className="services">
            <a href="#" onClick={toggleDropdown}>Services <FontAwesomeIcon icon={faCaretDown} /></a>
            <ul className={dropdownOpen ? 'dropdown active' : 'dropdown'}>
              <li><a href="#" onClick={closeMenu}>Project</a></li>
              <li><a href="#" onClick={closeMenu}>Web</a></li>
              <li><a href="#" onClick={closeMenu}>Digital</a></li>
            </ul>
          </li>
